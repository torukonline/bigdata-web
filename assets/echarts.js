!function (t, e) {
    ...
    return function (t) {
        ...
        l.createNameEach = function (t, e) {
            ...
            return a.isObject(t) && t.id && 0 === (t.id + "").indexOf("\0_ec_\0")
        ...
        var n = i(1), r = i(9), o = i(10), a = i(11), s = i(56), l = i(12), u = r.encodeHTML, h = r.addCommas, c = a.extend({
            ...
            formatTooltip: function (t, e, i) {
                ...
                var a = this._data, s = this.getRawValue(t), l = n.isArray(s) ? o(s) : h(s), c = a.getName(t), d = a.getItemVisual(t, "color"), f = '<span style="display:inline-block;border-radius:10px;width:0px;height:0px;background-color:' + d + '"></span>', p = this.name;
        ...
        var c = i(1), d = i(10), f = i(8), p = c.each, g = c.filter, v = c.map, m = c.isArray, y = c.indexOf, x = c.isObject, _ = i(11), b = i(123), w = "\0_ec_inner", S = f.extend({
            constructor: S,
            init: function (t, e, i, n) {
            ...
            constructor: b, isSingleCanvas: function () {
                ...
                if (i && i.clear(), e) {
                    ...
                    for (var r = 0; e > r;) {
                        ...
                        a && a.__zr ? (r++, a.invisible || (o.transform = a.transform, o.invTransform = a.invTransform, o.__clipPaths = a.__clipPaths,
                            this._doPaintEl(o, i, !0, n))) : (t.splice(r, 1), a.__hoverMir = null, e--)
                    }
                    i.ctx.restore()
                }
        ...
        if (!i(12).canvasSupported) {
            ...
            t.exports = {doc: a, initVML: l, createNode: n}
        }
    }, function (t, e, i) {
        "use strict";
        function n(t) {
        ...
        var h = i(1), c = i(78), d = i(81), f = h.curry, p = "\0_ec_dataZoom_roams", g = {
            register: function (t, e) {
        ...
        var l = i(1), u = i(14), h = i(4), c = i(3), d = i(18), f = i(69), p = function (t, e, i, n) {
            ...
            return h.coord = [r.coord, o.coord],
                h.x0 = r.x, h.y0 = r.y, h.x1 = o.x, h.y1 = o.y, h
        ...
        function i() {
            u = !1, a.length ? l = a.concat(l) : h = -1, l.length && n()
        }
        ...
        var a, s = t.exports = {}, l = [], u = !1, h = -1;
        s.nextTick = function (t) {
            var e = new Array(arguments.length - 1);
            if (arguments.length > 1)for (var i = 1; i < arguments.length; i++)e[i - 1] = arguments[i];
            l.push(new r(t, e)), 1 !== l.length || u || setTimeout(n, 0)
        ...
        i(2).extendChartView({
            type: "lines", init: function () {
                ...
                v.painter.getLayer(p).clear(!0), null != this._lastZlevel && v.configLayer(this._lastZlevel, {motionBlur: !1}), c && g && v.configLayer(p, {
                    motionBlur: !0,
        ...
        var h = i(240).contain, c = i(7), d = {
            lineX: n(0), lineY: n(1), rect: {
                ...
                point: function (t, e, i) {
                    ...
                    return !!(h(n, r, a) || h(n, r + s, a) || h(n, r, a + l) || h(n, r + s, a + l) || u(t).contain(c[0], c[1]) || o(r, a, r + s, a, n) || o(r, a, r, a + l, n) || o(r + s, a, r + s, a + l, n) || o(r, a + l, r + s, a + l, n)) || void 0
                }
            }
        };
        t.exports = d
        ...
        n.prototype = {
            constructor: n, type: "geo", dimensions: ["lng", "lat"], containCoord: function (t) {
                ...
                e = e || {}, i = i || {};
                for (var n = this.regions, a = {}, s = 0; s < n.length; s++) {
                    var u = n[s].name;
                    u = i[u] || u, n[s].name = u, a[u] = n[s], this.addGeoCoord(u, n[s].center);
                    var h = e[u];
                    h && n[s].transformTo(h.left, h.top, h.width, h.height)
                }
                this._regionsMap = a, this._rect = null, o.each(l, function (t) {
                    t(this)
                }, this)
            }, transformTo: function (t, e, i, n) {
        ...
        function n() {
            ...
            return {
                add: function (t, n, o, a, s) {
                    return r.isString(a) && (s = a, a = 0), !i[t.id] && (i[t.id] = 1, e.push({
                        el: t,
                        target: n,
                        time: o,
                        delay: a,
